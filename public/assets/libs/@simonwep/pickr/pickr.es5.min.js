  ...
  (() => {
    ...
    var t = {
        ...
        7022: (t, e, r) => {
          ...
          t.exports = function (t) {
            ...
            var y,
              ...
              A = 0;
            if (!_ || (this === v && c(_)))
              for (y = s(e), b = r ? new this(y) : v(y); y > A; A++)
                (S = g ? d(e[A], A) : e[A]), l(b, A, S);
            else
              for (
                ...
                (S = g ? a(x, d, [m.value, A], !0) : m.value), l(b, A, S);
            return (b.length = A), b;
          };
        },
        1675: (t, e, r) => {
              ...
              return function (h, d, g, y) {
                for (
                  var b,
                    ...
                    A = 0,
                    O = y || u,
                    E = e ? O(h, S) : r || f ? O(h, 0) : void 0;
                  S > A;
                  A++
                )
                  if ((v || A in w) && ((m = _((b = w[A]), A, x)), t))
                    if (e) E[A] = m;
                    else if (m)
                      switch (t) {
                        case 3:
        ...
        654: (t, e, r) => {
          ...
          t.exports = function (t, e, r, a, h, g, E) {
            ...
            if (
              ...
              if (
                ((C = { values: P(_), keys: g ? F : P(S), entries: P(A) }), E)
              )
                for (k in C) (x || R || !(k in T)) && v(T, k, C[k]);
              else n({ target: e, proto: !0, forced: x || R }, C);
            return (
              (i && !E) || T[w] === F || v(T, w, F, { name: h }), (d[e] = F), C
            );
          };
        },
        2603: (t, e, r) => {
        ...
        5567: (t, e, r) => {
          ...
          t.exports =
            ...
            a(function () {
              ...
              ? function (t, e) {
                  for (
                    var r = l(t), o = arguments.length, a = 1, f = u.f, v = s.f;
                    o > a;
          ...
          (S || A || _ || v || h) &&
            (y = function (t) {
              ...
              if (
                ...
                for (o.groups = s = p(null), a = 0; a < j.length; a++)
                  s[(l = j[a])[0]] = o[l[1]];
              return o;
            }),
            (t.exports = y);
          ...
          var n = r(2538),
            ...
            p = function (t) {
              return function (e, r, n) {
                ...
                return v <= h || "" === d
                  ? f
                  : ((p = u(d, l((a = v - h) / d.length))).length > a &&
                      (p = s(p, 0, a)),
                    t ? f + p : p + f);
              };
            };
        ...
        3633: (t, e, r) => {
          ...
          t.exports = function (t) {
            return (
              i(l, t) || (l[t] = c && i(s, t) ? s[t] : p("Symbol." + t)), l[t]
            );
          };
        },
        9662: (t) => {
            ...
            { target: "Array", proto: !0, forced: !h },
            {
              slice: function (t, e) {
                ...
                if (
                  ...
                  return v(f, b, m);
                for (
                  n = new (void 0 === r ? g : r)(y(m - b, 0)), p = 0;
                  b < m;
                  b++, p++
                )
                  b in f && l(n, p, f[b]);
            ...
            function (t, e, r) {
              ...
              return [
                ...
                function (t, n) {
                  ...
                  for (var A = 0, O = 0, E = []; O < c.length; ) {
                    w.lastIndex = y ? 0 : O;
                    var j,
                      C = h(w, y ? x(c, O) : c);
                    if (
                      null === C ||
                      (j = b(p(w.lastIndex + (y ? O : 0)), c.length)) === A
                    )
                      O = l(c, O, d);
                    else {
                      if ((m(E, x(c, A, O)), E.length === _)) return E;
          ...
          s ||
            (j(
              (Y = (z = function () {
                ...
                return (
                  u && it && ct(W, e, { configurable: !0, set: r }), ut(e, t)
                );
              })[G]),
              "toString",
              function () {
              ...
              switch (o) {
                ...
                case "hsla":
                  ...
                  if (
                    ...
                    break t;
                  return { values: [].concat(x(_, A, O), [E]), a: E, type: o };
                case "hsva":
                  var j = n(e),
                    C = j[1],
                    k = j[2],
        ...
        var R = (function () {
          function e(t) {
            ...
            (this._initializingActive = !0),
              ...
              (this.options = t =
                Object.assign(Object.assign({}, e.DEFAULT_OPTIONS), t));
            var n = t,
              o = n.swatches,
              i = n.components,
              a = n.theme,
