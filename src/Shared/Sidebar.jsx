          ...
          <ul className="main-menu" id="sidebarMenu">
            ...
            {role === "admin" && (
              <>
                ...
                <li
                  className={`slide has-sub ${openMenus.salary ? "open" : ""}`}
                >
                  <a
                    href="#dashboard"
                    className="side-menu__item"
                    onClick={(e) => toggleMenu("salary", e)}
                    aria-expanded={openMenus.salary}
                    aria-controls="dashboard-menu"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="side-menu__label"> Salary </span>
                    <i className="ri-arrow-down-s-line side-menu__angle"></i>
                  </a>
                  ...
                  <ul
                    ...
                    className="slide-menu child1"
                    style={{
                      display: openMenus.salary ? "block" : "none",
                      position: "relative",
                      left: "0px",
                      top: "0px",
                      margin: "0px",
  ...
  return (
    <>
      ...
      >
        ...
        <div className="offcanvas-body app-sidebar sticky">{sidebarMenu}</div>
      </div>
      {/* Desktop Sidebar visible only on md+ screens */}
      <aside className="app-sidebar sticky d-none d-lg-block" id="sidebar">
        {sidebarMenu}
      </aside>
    </>
  );
